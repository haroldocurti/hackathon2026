# Lista de Afazeres — Planejamento Hackathon Senac 2026 📋

Esta lista serve para acompanhar o progresso das tarefas de organização do **Hackathon Senac Ribeirão Preto 2026**. Você pode marcar as caixas com `[x]` à medida que as tarefas forem concluídas.
...
*   [x] Estruturar as 5 trilhas temáticas com focos de problematização locais e personas baseadas em dados do município (salvo na pasta [Desafios](file:///c:/Users/inomi/OneDrive%20-%20SENAC%20-%20SP/TI/Desenvolvimento%20de%20Sistemas/T01%20(teste)/hackathon%202026/Desafios)).
*   [ ] Revisar o regulamento final com a coordenação pedagógica da unidade.
*   [ ] Definir os indicadores de Unidades Curriculares (UCs) que poderão ser validados com a participação no evento (alinhamento com a equipe docente).
...
## 💻 Fase 3: Logística, Infraestrutura e Parcerias
*   [ ] Reservar os espaços físicos da unidade do Senac Ribeirão Preto (laboratórios de informática, auditório e salas de ideação).
...
## 🚀 Fase 5: Execução do Evento
*   **Dia 1: Abertura e Workshops**
    *   [ ] Credenciamento e check-in das equipes.
    *   [ ] Cerimônia de abertura institucional e explicação das regras.
    *   [ ] Realização das oficinas de ideação, design thinking e pitch preparatório.
    *   [ ] Momento de integração (networking) para fechamento do dia.
*   **Dia 2: Maratona e Pitches**
